...
const London = () => {
    ...
    function renderHeaderInfoSection(){
        return(
            ...
            >
                <Animated.Image 
                    source={require('../../res/images/london6.jpg')}
                    resizeMode="contain"
                    style={{
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <MaterialIcons name="fitness-center" size={24} color="#808080" style={{padding: 10}}/>
                    </View>
                    <View style={styles.infoHeaderStyle}>
                        <Text style={styles.infoStyle}>Fitness</Text>
                        <Text style={styles.infoStyle}>center</Text>
                    </View>
                </View>
                <View style={{
                    justifyContent: 'center',
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={styles.ratingStyle2}>4.5/5</Text>
                            </View>
                        </View>
                        <View style={{
                            bottom: -15
        ...
        return(
            <View style={{
                ...
                <Text style={{
                    ...
                    Overlooking London’s Green Park is the world-famous The Ritz London. This stunning 
                    Neoclassical building offers the height of opulence with luxurious bedrooms, exquisite 
                    British cuisine, and classic afternoon teas. Bedrooms at The Ritz London combine stunning 
                    period architecture and antique furnishings with modern amenities. Decorated in warm colours, 
                    they feature high ceilings, ornate fireplaces and chandeliers. Rooms are air-conditioned and 
                    feature iPod docks and elegant bathrooms with designer toiletries. There is complimentary WiFi 
                    throughout the hotel. The Michelin star Ritz Restaurant looks out over the gardens. It uses the 
                    finest of ingredients in cuisine that is classically British with a modern twist. The Rivoli Bar 
                    has an Art Deco style with gold leaf decoration. The Ritz Club London is close to many theatres of the West End.
                </Text>
            </View>
        )
    }
    ...
    function renderImageSliderInfoSection(){
        const [maldivesImages, setMaldivesImages] = useState([
            require('../../res/images/london5.jpg'),
            require('../../res/images/london4.jpg'),
            require('../../res/images/london6.jpg'),
            require('../../res/images/london2.jpg'),
            require('../../res/images/london3.jpg'),
            require('../../res/images/london1.jpg'),
        ]);
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            redeem your stay from any time between <Text style={{textDecorationLine:'underline', textDecorationColor:'black'}}> 23 May 2021 to 31 December 2021</Text>
                        </Text>
                    </View>
                    <View style={{
                        paddingTop: 10,
                        ...
                        <Text style={{
                            ...
                            receive a full refund in case of cancellation, 10 days
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            a travel expert from London will get in touch with you within 72 hours to 
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        wake up to the beautiful luxury of London Royal Palace when you stay in the lap of 
    ...
    function renderResortImageSliderInfoSection(){
        const [maldivesImages, setMaldivesImages] = useState([
            require('../../res/images/lhotel1.jpg'),
            require('../../res/images/lhotel2.jpg'),
            require('../../res/images/lhotel3.jpg'),
            require('../../res/images/lhotel4.jpg'),
            require('../../res/images/lhotel5.jpg'),
            require('../../res/images/lhotel6.jpg'),
        ]);
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            get access to a complimentary upgrade to the Luxury Royal Room
                        </Text>
                    </View>
                    <View style={{
                        paddingTop: 10,
                        ...
                        <Text style={{
                            ...
                            enjoy a premium dinner and bar
                        </Text>
                    </View>
                    <View style={{
                        paddingTop: 10,
                        ...
                        <Text style={{
                            ...
                            enjoy an exclusive 20% off on spa
                        </Text>
                    </View>
                </View>
            </View>
    ...
    function renderRoomSelectionInfoSection(){
        ...
        const selectAmount = () => {
            if(roomType === "Superior King Room"){
                return "Pay ₹2,22,794"
            }else if(roomType === "Executive King Room") {
                return "Pay ₹2,62,289"
            }else if(roomType === "Deluxe King Room") {
                return "Pay ₹2,98,970"
                                ...
                                <View style={{
                                    ...
                                    <RNPickerSelect
                                        ...
                                        items={[
                                            ...
                                            { label: "Executive King Room", value: "Executive King Room" },
                                            { label: "Deluxe King Room", value: "Deluxe King Room" },
    ...
    return(
        <View style={styles.container}>
            <StatusBar backgroundColor={'#001aa2'} barStyle="light-content" />
            <Animated.FlatList 
                data={sectionData}
