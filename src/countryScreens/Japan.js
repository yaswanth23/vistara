...
const Singapore = () => {
    ...
    function renderHeaderInfoSection(){
        return(
            ...
            >
                <Animated.Image 
                    source={require('../../res/images/japan2.jpg')}
                    resizeMode="contain"
                    style={{
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <MaterialIcons name="spa" size={24} color="#808080" style={{padding: 10}}/>
                    </View>
                    <View style={styles.infoHeaderStyle}>
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <Text style={styles.ratingStyle2}>8.5/10</Text>
                            </View>
                        </View>
                        <View style={{
                            bottom: -15
        ...
        return(
            <View style={{
                ...
                <Text style={{
                    ...
                    The Ritz-Carlton Tokyo is directly connected to Roppongi Station, which offers easy subway 
                    access to Shinjuku and Akihabara. The National Art Centre and Roppongi Hills are about a 10-minute walk. 
                    Tokyo Station and the Imperial Palace are both a 20-minute taxi ride away. Guests can pamper themselves with 
                    a treatment at the spa, or unwind in a whirlpool with city skyline views. Other facilities include saunas, 
                    a gym and bicycle rental.
                </Text>
            </View>
        )
    }
    ...
    function renderImageSliderInfoSection(){
        const [maldivesImages, setMaldivesImages] = useState([
            require('../../res/images/japan1.jpg'),
            require('../../res/images/japan2.jpg'),
            require('../../res/images/japan3.jpg'),
            require('../../res/images/japan4.jpg'),
        ]);
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{
                            ...
                            redeem your stay from any time between <Text style={{textDecorationLine:'underline', textDecorationColor:'black'}}> 15 April 2021 to 31 December 2021</Text>
                        </Text>
                    </View>
                    <View style={{
                        paddingTop: 10,
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <Text style={{
                        ...
                        Located at the heart of the downtown Roppongi area in Tokyo's tallest building, the 53rd-storey 
                        Ritz-Carlton offers elegant luxury high above Tokyo’s busy streets. It features an indoor pool and 8 
                        dining options. Free WiFi is available throughout the property.
                    </Text>
                </View>
            </View>
        )
    ...
    function renderResortImageSliderInfoSection(){
        const [maldivesImages, setMaldivesImages] = useState([
            require('../../res/images/jhotel1.jpg'),
            require('../../res/images/jhotel2.jpg'),
            require('../../res/images/jhotel3.jpg'),
            require('../../res/images/jhotel4.jpg'),
            require('../../res/images/jhotel5.jpg'),
            require('../../res/images/jhotel6.jpg'),
        ]);
    ...
    function renderRoomSelectionInfoSection(){
        ...
        const selectAmount = () => {
            if(roomType === "Carlton Suite"){
                return "Pay ₹46,891"
            }else if(roomType === "Club Tower Suite") {
                return "Pay ₹66,988"
            }else if(roomType === "Millenia Suite") {
                return "Pay ₹73,686"
            }else {
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <RNPickerSelect
                                        ...
                                        items={[
                                            { label: "Carlton Suite", value: "Carlton Suite" },
                                            { label: "Club Tower Suite", value: "Club Tower Suite" },
                                            { label: "Millenia Suite", value: "Millenia Suite" },
                                        ]}
                                        style={{
                                            inputIOS: {
                                                paddingLeft: 20,
    ...
    return(
        <View style={styles.container}>
            <StatusBar backgroundColor={'#016982'} barStyle="light-content" />
            <Animated.FlatList 
                data={sectionData}
